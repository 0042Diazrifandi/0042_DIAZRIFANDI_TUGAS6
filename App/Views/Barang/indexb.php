...
<body>
    <div class="container">
        ...
        <h1>Daftar Barang</h1>
        <a href="index.php?controller=barang&action=create" class="btn btn-blue">Tambah Data</a>
            ...
            <tbody>
                <?php foreach ($data as $key => $barang): ?>
                    <tr>
                        ...
                        <td><?= $barang['stok'] ?></td>
                        <td>
                            <a href="index.php?controller=barang&action=edit&id=<?= $barang['kode_barang'] ?>" class="btn-edit">Edit</a>
                            <a href="index.php?controller=barang&action=delete&id=<?= $barang['kode_barang'] ?>" class="btn-hapus" onclick="return confirm('Kamu yakin akan menghapus data ini ?');">Hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
