...
<body>
    <div class="container">
        ...
        <a href="index.php?controller=pelanggan&action=create" class="btn btn-blue">Tambah Data</a>
            ...
            <tbody>
                <?php foreach ($data as $key => $pelanggan): ?>
                    <tr>
                        ...
                        <td>
                            <a href="index.php?controller=pelanggan&action=edit&id=<?= $pelanggan['id_pelanggan'] ?>" class="btn-edit">Edit</a>
                            <a href="index.php?controller=pelanggan&action=delete&id=<?= $pelanggan['id_pelanggan'] ?>" class="btn-hapus" onclick="return confirm('Kamu yakin akan menghapus data ini ?');">Hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
